    ...
    <div className="py-12">
      ...
      <div className="text-center mb-16">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Button size="lg" variant="outline" href="/practice">
            Try Practice Mode
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {features.map((feature) => (
          ...
          >
            ...
            <Button variant="outline" href={feature.href} className="mt-auto">
              Learn More
            </Button>
          </Card>
        ))}
      ...
      <div className="mt-16 text-center">
        ...
        <Button size="lg" href="/simulation">
          Try Financial Simulation
        </Button>
      </div>
    </div>
  );
